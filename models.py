...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # maxpooling layers, multiple conv layers, fully-connected layers, and other layers (such as dropout or batch normalization) to avoid overfittingself.pool = nn.MaxPool2d(kernel_size=2, stride=2)

        self.fcl1 = nn.Linear(6400, 2000)
